...
class ElasticApplicationTemplate(object):
...
TRACES_DIR = os.path.join(os.path.dirname(__file__), "../appinfo/elasticinfo")
ELASTIC_APPLICATIONS = {
    "bert": ElasticApplicationTemplate(os.path.join(TRACES_DIR, "bert"), max_epochs=2),
    "cifar10": ElasticApplicationTemplate(os.path.join(TRACES_DIR, "cifar10"), max_epochs=100),
    "ncf": ElasticApplicationTemplate(os.path.join(TRACES_DIR, "ncf"), max_epochs=10),
    "imagenet": ElasticApplicationTemplate(os.path.join(TRACES_DIR, "imagenet"), max_epochs=90),
    "deepspeech2": ElasticApplicationTemplate(os.path.join(TRACES_DIR, "deepspeech2"), max_epochs=80),
    "yolov3": ElasticApplicationTemplate(os.path.join(TRACES_DIR, "yolov3"), max_epochs=50, max_local_bsz=8),
}

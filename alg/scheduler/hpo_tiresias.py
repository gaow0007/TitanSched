...
# TODO
# simplify the copy process 

class HPOTiresiasScheduler(BaseScheduler):
    def __init__(self, job_manager, cluster_manager, user_manager, placement, name, logger, **kwargs):
        super(HPOTiresiasScheduler, self).__init__(job_manager, cluster_manager, user_manager, placement=placement, name=name, logger=logger)
    ...
    def search_objective(self, ): 
        jct = 0
        num_job = len(self.completion_jobs)

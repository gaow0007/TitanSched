...
def parse_job_file(filename, job_type, job_manager, opt): 
    ...
    for idx, row in df.iterrows(): 
        ...
        if job_type == 'base': 
            ...
            job_instance = JobFactory(name=job_type)(row, add_ckpt=opt.add_ckpt, physical=opt.physical, failure_ratio=opt.failure_ratio*0.01, estimation_error=opt.estimation_error*0.01, profile=opt.profile_speed) 
